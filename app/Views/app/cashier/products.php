...
<main>
    ...
    <div class="flex">
        ...
        <div class="flex flex-col flex-1 min-w-0 font-secondary overflow-y-auto overflow-x-hidden min-h-screen" x-data="cashierProducts()"
            x-init="init()">
            ...
            <div class="mt-4 md:mt-6 lg:mt-8 px-4 md:px-6 lg:px-8 pb-20 flex flex-col 2xl:flex-row gap-5">
                <div class="flex flex-col space-y-2 w-full 2xl:w-auto 2xl:flex-1 min-w-0">
                    <div class="px-1">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    <template x-for="(product, index) in paginatedProducts" :key="product.id">
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-3 text-sm text-center" x-text="product.category_name">
                                            </td>
                                            <td class="px-4 py-3 text-sm text-center">
                                            ...
                                            <td class="px-4 py-3 text-sm space-x-2 flex items-center justify-center">
                                                <button type="button" @click="openDetail(product)" title="Detail"
                ...
                <div class="flex flex-col gap-4 w-full 2xl:w-1/3">
                    ...
                    <div class="flex flex-col space-y-2">
                                ...
                                <table class="w-full min-w-max">
                                    ...
                                    <tbody class="divide-y divide-gray-200 text-sm">
                                        ...
                                        <template x-for="r in paginatedRestocks" :key="r.id">
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-4 py-3 text-center" x-text="formatDateTime(r.created_at)">
                                                </td>
                                                ...
                                                <td class="px-4 py-3 text-center">
                                                    <template x-if="r.receipt_image || r.user_note">
                                                        <button @click="openViewProof(r)" class="text-blue-600 hover:text-blue-800" title="Lihat Bukti">
                        ...
                        <div x-cloak x-show="openRestockModal" x-transition:enter="transition ease-out duration-300"
                            ...
                            <div
                                class="w-full max-w-sm sm:max-w-md lg:max-w-lg bg-white rounded-xl shadow-2xl overflow-hidden">
                                ...
                                <div class="bg-primary flex items-center justify-between px-5 py-4">
                                    ...
                                    <button @click="closeRestock()"
                                        class="p-2 rounded-md bg-white/10 hover:bg-white/20 text-white">
                                ...
                                <div class="px-5 py-4 space-y-3 max-h-[70vh] overflow-y-auto">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <div>
                                            ...
                                            <div class="mt-1 flex items-center gap-1">
                                                <button @click="decQty()"
                                                    class="px-2 py-2 bg-gray-100 rounded hover:bg-gray-200">
                                    ...
                                    <div>
                                        ...
                                        <select x-model="restockLocationId" @change="onRestockLocationChange()"
                                            ...
                                            <template
                                                x-for="loc in locations.filter(l => l.status === 'active').sort((a,b) => (a.rack || '').localeCompare(b.rack || '') || (a.row || '').localeCompare(b.row || ''))"
                                                :key="loc.id">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 p-4 border-2 border-dashed rounded-md text-center text-gray-500 hover:border-primary/60 hover:text-primary/80 cursor-pointer"
                                            @click="receiptPick()" @dragover.prevent
                                            @drop.prevent="handleReceiptDrop($event)">
                                            <i class="fas fa-cloud-upload-alt text-xl mb-1"></i>
                                            <p class="text-sm"
                                                x-text="receiptFileName ? 'File: ' + receiptFileName : 'Upload file'">
                                            </p>
                                            <input type="file" x-ref="receiptInput" class="hidden"
                                                @change="receiptChange($event)" accept="image/*,.pdf">
                                        </div>
                                    </div>
                            ...
                            <div class="w-full max-w-md bg-white rounded-xl shadow-xl overflow-hidden">
                                ...
                                <div class="px-5 py-4">
                                    <div class="flex items-center gap-4">
                                        <div
                                            class="w-20 h-20 bg-gray-100 rounded flex items-center justify-center overflow-hidden">
                                            <template x-if="selectedProduct?.photo">
                                                <img :src="selectedProduct.photo" alt="Photo"
                                                    class="w-full h-full object-cover">
                                            </template>
                                            <template x-if="!selectedProduct?.photo">
                                                <img src="<?= base_url('images/placeholder-product.svg') ?>"
                                                    alt="No photo" class="w-full h-full object-cover">
                                            </template>
                                        </div>
                                        <div>
                                            <h4 class="font-semibold text-gray-800"
                                                x-text="selectedProduct?.product_name"></h4>
                                            <p class="text-sm text-gray-600"
                                                x-text="formatCurrency(selectedProduct?.price || 0)"></p>
                                            ...
                                            <p class="text-sm text-gray-500">Stok: <span
                                                    :class="stockClass(selectedProduct?.stock || 0)"
                                                    x-text="selectedProduct?.stock || 0"></span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="bg-white rounded-lg border">
                                            <div class="overflow-x-auto max-h-[40vh] overflow-y-auto">
                                                <table class="w-full min-w-max text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <template
                                                            x-if="!selectedProduct || visibleBatches.length === 0">
                                                            <tr>
                                                                <td colspan="4"
                                                                    class="px-3 py-4 text-center text-gray-500">Tidak
                                                                    ada batch aktif yang ditampilkan</td>
                                                            </tr>
                                                        </template>
                                                        <template x-for="b in visibleBatches" :key="b.id">
                                                            <tr class="hover:bg-gray-50">
                                                                <td class="px-3 py-2" x-text="b.expired_date || '-' ">
                                                                </td>
                                                                <td class="px-3 py-2 text-right"
                                                                    x-text="b.current_stock"></td>
                                                                <td class="px-3 py-2 text-right"
                                                                    x-text="formatCurrency(b.purchase_price || 0)"></td>
                                                                <td class="px-3 py-2">
                                                                    <span
                                                                        x-text="[b.rack, b.row].filter(Boolean).join(' / ') || '-' "></span>
                                                                </td>
                                                            </tr>
                                                        </template>
                                                    </tbody>
                                        ...
                                        <div class="text-xs text-gray-500 mt-1">Catatan: batch yang expired atau
                                            near-expired (≤ 7 hari) tidak ditampilkan.</div>
                                    </div>

                                    <div class="mt-4 flex flex-col items-center">
                                        <div class="bg-white p-4 rounded-md shadow-inner">
                                            <img :src="'<?= base_url('cashier/products/barcode/image/') ?>' + encodeURIComponent(selectedProduct?.barcode || '')"
                    ...
                    <!-- Filter Modal -->
                    <div x-show="openFilterModal" class="fixed inset-0 z-50 overflow-y-auto"
                            ...
                            <div x-show="openFilterModal" x-transition:enter="ease-out duration-300"
                                ...
                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    ...
                                    <div class="space-y-6 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                                        <div>
                                            <label
                                                class="block text-sm font-semibold text-gray-900 mb-3">Kategori</label>
                                            <div class="flex flex-wrap gap-2">
                                                ...
                                                <button x-show="categories.length > 8"
                                                    ...
                                                    <span
                                                        x-text="showAllCategories ? 'Sembunyikan' : 'Lihat Lainnya'"></span>
                                                    <i class="fas"
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-900 mb-3">Status
                                                Stok</label>
                                            <div class="flex flex-wrap gap-2">
                                        ...
                                        <div>
                                            <label
                                                class="block text-sm font-semibold text-gray-900 mb-3">Urutkan</label>
                                            ...
                                            {id: 'stock_low', label: 'Stok Sedikit', icon: 'fa-exclamation-triangle'}
                                                    ...
                                                    <div @click="tempFilters.sort = sortOption.id"
                                                        ...
                                                        <div x-show="tempFilters.sort === sortOption.id"
                                                            class="text-primary">
