        ...
        <div class="flex flex-col flex-1 font-secondary overflow-y-auto min-h-screen"
            ...
            <div class="mt-4 md:mt-6 lg:mt-8 px-4 md:px-6 lg:px-8 lg:pb-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div x-show="showItemsModal" class="fixed inset-0 bg-black/40 flex items-center justify-center" style="display:none">
                        <div class="bg-white w-11/12 md:w-2/3 lg:w-1/2 rounded-lg shadow-md p-4">
                            <div class="flex justify-between items-center">
                                <h3 class="font-semibold">Items Transaksi <span class="text-primary" x-text="currentTransactionId"></span></h3>
                                <button @click="closeItems()" class="text-sm px-3 py-1 bg-white border rounded-md hover:bg-gray-50">Tutup</button>
                            </div>
                                ...
                                <table class="w-full min-w-max">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th class="px-3 py-2 text-sm">Produk</th>
