...
<main class="">
    ...
    <div class="flex">
        ...
        <div x-data="dashboard()" x-init="init()"
            class="flex flex-col flex-1 font-secondary overflow-y-auto min-h-screen">
            <div class="flex justify-between items-center pt-22 px-4 pb-4 md:pt-24 md:px-6 md:pb-6 lg:p-8">
                <div class="">
                    ...
                    <p class="text-sm md:text-base text-gray-500">Selamat datang, <span
                            class="font-semibold text-shadow-primary"><?= session()->get('nama_lengkap') ?></span></p>
                </div>
            ...
            <div class="mt-4 md:mt-6 lg:mt-8 px-4 md:px-6 lg:px-8 pb-20">
                <div class="flex flex-col space-y-2">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div
                            class="bg-white rounded-md shadow-md flex justify-between items-center p-4 lg:p-6 overflow-hidden">
                            <div class="flex flex-col space-y-1">
                                <span class="text-sm text-gray-500">Total Penjualan</span>
                                <span class="text-base lg:text-lg font-bold text-primary"
                                    x-text="formatRupiah(data.todaySales)"></span>
                            </div>
                            <div
                                class="hidden lg:flex items-center justify-center aspect-square w-12 rounded-md bg-gradient-to-br from-primary to-accent-2 shadow-secondary shadow-md">
                        ...
                        <div class="bg-white rounded-md shadow-md flex justify-between items-center p-4 lg:p-6">
                            <div class="flex flex-col space-y-1">
                                ...
                                <span class="text-lg md:text-xl font-bold text-primary"
                                    x-text="data.todayTransactions"></span>
                            </div>
                            <div
                                class="hidden lg:flex items-center justify-center aspect-square w-12 rounded-md bg-gradient-to-br from-primary to-accent-2 shadow-secondary shadow-md">
                        ...
                        <div class="bg-white rounded-md shadow-md flex justify-between p-4 lg:p-6">
                            <div class="flex flex-col space-y-1">
                                ...
                                <span class="text-lg md:text-xl font-bold text-primary"
                                    x-text="data.todayItemsSold"></span>
                            </div>
                            <div
                                class="hidden lg:flex items-center justify-center aspect-square w-12 rounded-md bg-gradient-to-br from-primary to-accent-2 shadow-secondary shadow-md">
                        ...
                        <div class="bg-white rounded-md shadow-md flex justify-between p-4 lg:p-6">
                            <div class="flex flex-col space-y-1">
                                ...
                                <span class="text-lg md:text-xl font-bold text-primary"
                                    x-text="data.productNeedRestock"></span>
                            </div>
                            <div
                                class="hidden lg:flex flex-shrink-0 items-center justify-center aspect-square w-12 rounded-md bg-gradient-to-br from-primary to-accent-2 shadow-secondary shadow-md">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4 lg:p-6 lg:w-1/3 flex flex-col">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="<?= base_url('admin/products') ?>"
                                    class="text-xs text-primary hover:underline">Lihat Semua</a>
                            </div>
                            <div class="flex-1 overflow-y-auto flex flex-col pr-1">
                                <template x-if="data.topProducts.length === 0">
                                    <div
                                        class="flex flex-col items-center justify-center flex-1 h-full py-4 min-h-[200px]">
                                        <img src="<?= base_url('images/illustration/nodata.png') ?>"
                                            class="w-24 md:w-36 lg:w-48 h-auto opacity-80 object-contain" alt="No Data">
                                        <p class="text-gray-500 text-center text-sm mt-2">Belum ada penjualan hari ini.
                                        </p>
                                    </div>
                                </template>
                                <div class="grid grid-cols-3 gap-2" x-show="data.topProducts.length > 0">
                                    <template x-for="(product, index) in data.topProducts.slice(0, 6)" :key="index">
                                        <div
                                            class="bg-white border border-gray-100 rounded-lg p-2 hover:shadow-md transition-shadow duration-200 flex flex-col h-full">
                                            <!-- Product Image -->
                                            <div
                                                class="aspect-square w-full bg-gray-50 rounded-md overflow-hidden border border-gray-100 mb-2 relative group">
                                                ...
                                                <!-- Rank Number -->
                                                <div
                                                    class="absolute top-1 left-1 bg-black/50 backdrop-blur-[1px] text-white text-[8px] font-bold px-1 py-0.5 rounded flex items-center justify-center min-w-[14px]">
                                            ...
                                            <div class="flex flex-col flex-1 justify-between min-w-0">
                                                <div class="mb-1">
                                                    <div class="text-[9px] uppercase tracking-wider text-gray-500 font-medium truncate"
                                                        x-text="product.category_name || 'Uncategorized'"></div>
                                                    <h3 class="text-[11px] font-bold text-gray-800 leading-tight truncate mt-0.5"
                                                ...
                                                <div class="flex items-end justify-between">
                                                    ...
                                                    <div class="text-[9px] font-medium text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded-full"
                                                        x-text="product.total_sold + ' Sold'"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </template>
                                    ...
                                    <tbody>
                                        <template x-for="trx in data.recentTransactions" :key="trx.id">
                                            <tr class="bg-white border-b hover:bg-gray-50">
                                                <td class="px-4 py-2"
                                                    x-text="new Date(trx.transaction_date).toLocaleTimeString('id-ID', {hour: '2-digit', minute:'2-digit'})">
                                                </td>
                                                <td class="px-4 py-2" x-text="trx.cashier_name"></td>
                                                <td class="px-4 py-2 text-right font-medium text-gray-900"
                                                    x-text="formatRupiah(trx.total)"></td>
                                            </tr>
                                        </template>
                                        <template x-if="data.recentTransactions.length === 0">
                                            <tr>
                                                <td colspan="3" class="text-center py-4">
                                                    <div
                                                        class="flex flex-col items-center justify-center min-h-[150px]">
                                                        <img src="<?= base_url('images/illustration/nodata.png') ?>"
                                                            class="w-24 md:w-36 lg:w-48 h-auto opacity-80 object-contain"
                                                            alt="No Data">
